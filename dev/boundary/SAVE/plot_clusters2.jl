...
Base.@kwdef struct ClusterPlotConfig
    # ── background render ──────────────────────────────────────────
    pixel_size_nm   :: Float64  = 1.0       # rendered pixel size (nm); smaller = finer detail
...
#   scalebar        :: Bool     = true      # draw a physical scale bar on the rendered image
    ...
    boundary_linewidth :: Float64 = boundary_linewidth_default  # outline line width in points; driven by cluster_driver.jl
