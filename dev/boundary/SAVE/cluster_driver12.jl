...
Base.@kwdef struct ClusterPlotConfig
    # ── background render ──────────────────────────────────────────
    pixel_size_nm   :: Float64  = 97.8     # rendered pixel size (nm); smaller = finer detail
...
#   shrink      = 0.5,  # 0 = convex hull, 1 = tightest alpha-shape
    shrink      = 0.25,  # 0 = convex hull, 1 = tightest alpha-shape
...
#   pixel_size_nm = 97.8,          # 10 nm pixels → fine enough for 50 nm DBSCAN
